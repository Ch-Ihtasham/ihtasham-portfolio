...
export const DATA = {
  ...
  contact: {
    email: "cihtasham32@gmail.com",
    tel: "+92 3037709300",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Ch-Ihtasham",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ch-ihtasham/",
        icon: Icons.linkedin,
  ...
  work: [
    {
      ...
      description:
        "Quilcoders is a company that offers a range of solutions and services, culminating in final products. This comprehensive approach ensures that clients receive end-to-end support",
    },
    {
  ...
  education: [
    {
      school: "Anmol Public High School System",
      href: "",
      degree: "Matric",
    ...
    {
      school: "University of Agriculture",
